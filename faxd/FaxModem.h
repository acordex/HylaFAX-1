...
//    tiff_bytecount_t*	savedStripByteCounts;	// byte counts at start of page data (Acordex removed)
    tiff_offset_t	savedWriteOff;	// file offset at start of page data (Acordex added)
